...
import com.example.library.SuperTextView;
...
public class TypeActivity extends AppCompatActivity {
    ...
    private void setData() {
        ...
        Picasso.with(this).load("https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=3860616424,1789830124&fm=80&w=179&h=119&img.PNG")
                .placeholder(R.mipmap.head_default).into((ImageView) superTextView.getView(SuperTextView.leftImageViewId));
        Picasso.with(this).load("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=219781665,3032880226&fm=80&w=179&h=119&img.JPEG")
                .placeholder(R.mipmap.head_default).into((ImageView) superTextView2.getView(SuperTextView.rightImageViewId));
